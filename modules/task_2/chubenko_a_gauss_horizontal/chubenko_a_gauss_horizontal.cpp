...
horizontalGaussianMethod(const std::vector<double> &global_matrix,
  ...
  // int pivot_iter[n];
  // double local_full_matrix[local_size * (n + 1)];
  // double local_matrix[local_size * n];
  // double local_rhs[local_size];
  // double local_solution[local_size];
  // int global_solution_index[n];
  // double *global_solution = new double[n];
